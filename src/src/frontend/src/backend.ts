...
export class Backend implements backendInterface {
    ...
    async addClip(arg0: string, arg1: string, arg2: string, arg3: string, arg4: string): Promise<Clip> {
        if (this.processError) {
            try {
                const result = await this.actor.addClip(arg0, arg1, arg2, arg3, arg4);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async deleteClip(arg0: bigint): Promise<boolean> {
        if (this.processError) {
            try {
    ...
    async getAllClips(): Promise<Array<Clip>> {
        if (this.processError) {
            try {
    ...
    async getClipsByCategory(arg0: string): Promise<Array<Clip>> {
        if (this.processError) {
            try {
                const result = await this.actor.getClipsByCategory(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async searchClips(arg0: string): Promise<Array<Clip>> {
        if (this.processError) {
            try {
                const result = await this.actor.searchClips(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
